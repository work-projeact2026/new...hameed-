...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val layoutDirection = if (currentLang == "ur" || currentLang == "ar") {
                LayoutDirection.Rtl
            } else {
                LayoutDirection.Ltr
            }
            ...
            val updatedConfig = remember(currentLang) {
                    ...
                    NavHost(
                        ...
                        composable("settings") {
                            SettingsScreen(
                                ...
                                onLanguageClick = { navController.navigate("language_select_settings") },
                        ...
                        composable("language_select_settings") {
                            LanguageSelectionScreen(
                                currentLanguage = currentLang,
                                onLanguageSelected = { lang ->
                                    coroutineScope.launch {
